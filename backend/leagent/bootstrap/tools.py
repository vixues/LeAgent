...
_CURATED_UTIL_TOOL_PATHS: tuple[tuple[str, str], ...] = (
    ...
    # --- code ---
    ("leagent.code.execution", "CodeExecutionTool"),
    ...
    ("leagent.project.tools.edit", "ProjectEditTool"),
    ("leagent.project.tools.multiedit", "ProjectMultieditTool"),
    ("leagent.project.tools.patch", "ProjectApplyPatchTool"),
    ("leagent.project.tools.grep", "ProjectGrepTool"),
    ("leagent.project.tools.glob", "ProjectGlobTool"),
    ("leagent.project.tools.tree", "ProjectTreeTool"),
    ("leagent.project.tools.outline", "ProjectOutlineTool"),
    ("leagent.project.tools.shell", "ProjectShellTool"),
    # --- coding-project supervisor (live preview) ---
    ("leagent.project.scaffold.tools", "CodingProjectScaffoldTool"),
    ("leagent.project.scaffold.tools", "CodingProjectRunTool"),
    ("leagent.project.scaffold.tools", "CodingProjectStopTool"),
    ("leagent.project.scaffold.tools", "CodingProjectStatusTool"),
    ("leagent.project.scaffold.tools", "CodingProjectReadTool"),
